...
const ForwardedTransition = React.forwardRef<any, TransitionProps & ReactComponentProps>(Transition);
...
export const ItemImageViewFullScreen: React.FC<ItemImageViewFullScreenProps> = ({isOpen, close, images}) => {
  return (
      <Dialog
        fullScreen
        open={isOpen}
    ...
    background: 'transparent', boxShadow: 'none', color: "inherit"
    }}>
          <Toolbar>
            <IconButton
              edge="start"
